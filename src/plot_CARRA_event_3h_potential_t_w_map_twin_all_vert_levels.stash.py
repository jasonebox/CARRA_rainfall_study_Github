    ...
    for hh in range(n_hours):
        ...
        if hh>=0:
            ...
            if annotatex:
                ...
                xx0=1.15 ; yy0=1
                mult=1.
                ax.text(xx0, yy0, times[hh].strftime('%Y %b %d %HUTC'),
            ...
            if ly == 'p':
                if by_date:
                    figpath='/Users/jason/0_dat/CARRA/Figs_w_vs_elev/'+times[hh].strftime('%Y%m%d%H')+'/'
                else:
                ...
                figname=figpath+str(x0).zfill(3)+'_'+times[hh].strftime('%Y%m%d%H')+'_'+var_choice+pseudo_name
