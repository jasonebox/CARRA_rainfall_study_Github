...
path='/Users/jason/Dropbox/NAO/NCDC monthly NAO 1950-2021/'
os.chdir(path)


NAO=pd.read_csv('/Users/jason/Dropbox/NAO/NCDC monthly NAO 1950-2021/output/NAO_1950_20222.csv')
NAO=NAO[NAO.year>1990]
NAO=NAO[NAO.year<2022]
# print(NAO)

NAO = NAO.reset_index(drop=True)

NAO_phase='NAO-'
# NAO_phase='NAO+'
value=0.2
if NAO_phase=='NAO+':
    v=np.where(NAO.NAO.values>value)
if NAO_phase=='NAO-':
    v=np.where(NAO.NAO.values<-value)
...
cm='bwr'
meanx.astype(dtype=np.float16).tofile('/Users/jason/Dropbox/CARRA/CARRA_rainfall_study/output/'+varnam+'_average_'+NAO_phase+'_1269x1069.npy')
...
varnam='tp'
th=1
fn='/Users/jason/Dropbox/CARRA/CARRA_rainfall_study/output/'+varnam+'_average_'+NAO_phase+'_1269x1069.npy'
...
if annotatex:
    ...
    plt.text(xx0, yy0+cc*dy2,NAO_phase, fontsize=font_size*mult,
             transform=ax.transAxes,color=color_code) ; cc+=1.
...
if tight_layout:
    ...
    if ly =='p':
      ...
      # os.system('open /tmp/t.png')
        ...
        fn=figpath+varnam+'_NAO_composite_'+NAO_phase+'.png'
        out_im.save(fn)  
        os.system('open '+fn)
else:
        figpath='/Users/jason/Dropbox/CARRA/CARRA_rainfall_study/Figs/'
        figname=figpath+varnam+'_NAO_composite_'+NAO_phase+'.png'
