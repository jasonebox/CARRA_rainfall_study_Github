...
varnam='tp'
th=1
fn='/Users/jason/Dropbox/CARRA/CARRA_rainfall_study/output/tp_average_NAO-_1269x1069.npy'
...
if annotatex:
    ...
    plt.text(xx0, yy0+cc*dy2,varnam2, fontsize=font_size*mult,
             transform=ax.transAxes,color=color_code) ; cc+=1.   
    plt.text(xx0, yy0+cc*dy2,'NAO+ minus NAO-', fontsize=font_size*mult,
             transform=ax.transAxes,color=color_code) ; cc+=1.
...
if tight_layout:
    ...
    if ly =='p':
      ...
      # os.system('open /tmp/t.png')
        ...
        fn=figpath+varnam+'_NAO_composite_NAO+_minus_NAO-.png'
        out_im.save(fn)  
        os.system('open '+fn)
else:
        figpath='/Users/jason/Dropbox/CARRA/CARRA_rainfall_study/Figs/'
        figname=figpath+varnam+'_NAO_composite_NAO+_minus_NAO-.png'
