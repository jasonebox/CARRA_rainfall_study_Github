...
for x0 in xs:
    ...
    for hh in range(n_hours):
        ...
        # if hh>=0:
            ...
            ax3.set_yticks(levs[0:-1],labels=['1000', '950', '925', '900', '875', '850', '825', '800', '750',
                   '700', '600', '500', '400'])
            ...
            if var_choice=='U':
                units='zontal winds, m s$\mathregular{^{-1}}$'
                cm=plt.cm.bwr
                cm.set_over('orange')
                cm.set_under('purple')
                lo=-30 ; hi=30 ; dx=4
                ...
                cntr=ax.contourf(X,Y,U,cmap=cm,levels=levs_W,vmin=lo,vmax=hi,extend='max')
